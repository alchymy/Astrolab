...
function generate_stellar_system ()
{
   //  planet_pointer 
	var planet;
     ...
     // Fix all normally RANDOM numbers
     
     stellar_mass_ratio = 1.2890; // random_number(0.6,1.3);
     ...
     main_seq_life = (stellar_mass_ratio / stellar_luminosity_ratio);
     if ((main_seq_life >= 6.0E9))
	  age = 3859E6; //random_number(1.0E9,6.0E9);
     else 
	  age = 3859E6; //random_number(1.0E9,main_seq_life);
